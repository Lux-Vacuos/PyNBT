...
from pynbt import NBTFile, model
...
class BigTestModel(model.NBTModel):
    int_test = model.IntegerField(name='intTest')
    short_test = model.ShortField(name='shortTest')
...
class ModelTest(unittest.TestCase):
    ...
    def test_load_save(self):
        ...
        model = BigTestModel(nbt)
        model.int_test.value = -3
        model.save(nbt)

        self.assertEqual(nbt['intTest'].value, -3)
